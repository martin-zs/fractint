...
; external data
CEXTERN init      ;:TWORD  12 - LDBL each   ; declared as type complex
CEXTERN parm      ;:TWORD  12 - LDBL each   ; declared as type complex
CEXTERN new       ;:TWORD  12 - LDBL each   ; declared as type complex
CEXTERN maxit     ;:DWORD  4 - long
CEXTERN inside    ;:DWORD  4 - int
CEXTERN outside   ;:DWORD  4 - int
CEXTERN rqlim     ;:TWORD  12 - LDBL        ; bailout (I never did figure out
                                            ; what "rqlim" stands for. -Wes)
CEXTERN coloriter      ;:DWORD  4 - long
CEXTERN oldcoloriter      ;:DWORD  4 - long
CEXTERN realcoloriter      ;:DWORD  4 - long
