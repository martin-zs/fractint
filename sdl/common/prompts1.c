...
#else
    {s_sin,   lStkSin,   dStkSin   },
    {s_cosxx, lStkCosXX, dStkCosXX },
    {s_sinh,  lStkSinh,  dStkSinh  },
    {s_cosh,  lStkCosh,  dStkCosh  },
    {s_exp,   lStkExp,   dStkExp   },
    {s_log,   lStkLog,   dStkLog   },
    {s_sqr,   lStkSqr,   dStkSqr   },
    {s_recip, lStkRecip, dStkRecip }, /* from recip on new in v16 */
    {s_ident, StkIdent,  StkIdent  },
    {s_cos,   lStkCos,   dStkCos   },
    {s_tan,   lStkTan,   dStkTan   },
    {s_tanh,  lStkTanh,  dStkTanh  },
    {s_cotan, lStkCoTan, dStkCoTan },
    {s_cotanh,lStkCoTanh,dStkCoTanh},
    {s_flip,  lStkFlip,  dStkFlip  },
    {s_conj,  lStkConj,  dStkConj  },
    {s_zero,  lStkZero,  dStkZero  },
    {s_asin,  lStkASin,  dStkASin  },
    {s_asinh, lStkASinh, dStkASinh },
    {s_acos,  lStkACos,  dStkACos  },
    {s_acosh, lStkACosh, dStkACosh },
    {s_atan,  lStkATan,  dStkATan  },
    {s_atanh, lStkATanh, dStkATanh },
    {s_cabs,  lStkCAbs,  dStkCAbs  },
    {s_abs,   lStkAbs,   dStkAbs   },
    {s_sqrt,  lStkSqrt,  dStkSqrt  },
    {s_floor, lStkFloor, dStkFloor },
    {s_ceil,  lStkCeil,  dStkCeil  },
    {s_trunc, lStkTrunc, dStkTrunc },
    {s_round, lStkRound, dStkRound },
    {s_one,   lStkOne,   dStkOne   },
#endif
  };
