...
docolors:
      ...
      if (recordcolors !='c' && recordcolors != 'y' && *colorinf == '@')
      ...
      else
        {
          ...
          curc = force = 0;
          if (fake_lut && !truemode) loaddac(); /* FIXME: ??? stupid kludge JCO 6/23/2001 */
          for (;;)
            {
  ...
  if (curmode < 0)
    {
      switch (video_type)   /* set up a reasonable default (we hope) */
        {
        case 1:
          videoentry.videomodeax = 8;   /* hgc */
          videoentry.colors = 2;
          break;
        case 2:
          videoentry.videomodeax = 4;   /* cga */
          videoentry.colors = 4;
          break;
        case 3:
          videoentry.videomodeax = 16;  /* ega */
          ...
          break;
        default:
          videoentry.videomodeax = 19;  /* mcga/vga? */
