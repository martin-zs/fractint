...
#else
    {s_sin,   lStkSin,   dStkSin,   dStkSin   },
    {s_cosxx, lStkCosXX, dStkCosXX, dStkCosXX },
    {s_sinh,  lStkSinh,  dStkSinh,  dStkSinh  },
    {s_cosh,  lStkCosh,  dStkCosh,  dStkCosh  },
    {s_exp,   lStkExp,   dStkExp,   dStkExp   },
    {s_log,   lStkLog,   dStkLog,   dStkLog   },
    {s_sqr,   lStkSqr,   dStkSqr,   dStkSqr   },
    {s_recip, lStkRecip, dStkRecip, dStkRecip }, /* from recip on new in v16 */
    {s_ident, StkIdent,  StkIdent,  StkIdent  },
    {s_cos,   lStkCos,   dStkCos,   dStkCos   },
    {s_tan,   lStkTan,   dStkTan,   dStkTan   },
    {s_tanh,  lStkTanh,  dStkTanh,  dStkTanh  },
    {s_cotan, lStkCoTan, dStkCoTan, dStkCoTan },
    {s_cotanh,lStkCoTanh,dStkCoTanh,dStkCoTanh},
    {s_flip,  lStkFlip,  dStkFlip,  dStkFlip  },
    {s_conj,  lStkConj,  dStkConj,  dStkConj  },
    {s_zero,  lStkZero,  dStkZero,  dStkZero  },
    {s_asin,  lStkASin,  dStkASin,  dStkASin  },
    {s_asinh, lStkASinh, dStkASinh, dStkASinh },
    {s_acos,  lStkACos,  dStkACos,  dStkACos  },
    {s_acosh, lStkACosh, dStkACosh, dStkACosh },
    {s_atan,  lStkATan,  dStkATan,  dStkATan  },
    {s_atanh, lStkATanh, dStkATanh, dStkATanh },
    {s_cabs,  lStkCAbs,  dStkCAbs,  dStkCAbs  },
    {s_abs,   lStkAbs,   dStkAbs,   dStkAbs   },
    {s_sqrt,  lStkSqrt,  dStkSqrt,  dStkSqrt  },
    {s_floor, lStkFloor, dStkFloor, dStkFloor },
    {s_ceil,  lStkCeil,  dStkCeil,  dStkCeil  },
    {s_trunc, lStkTrunc, dStkTrunc, dStkTrunc },
    {s_round, lStkRound, dStkRound, dStkRound },
    {s_one,   lStkOne,   dStkOne,   dStkOne   },
#endif
  };
          ...
          if ((i = getakeynohelp()) == DOWN_ARROW || i == DOWN_ARROW_2
              ...
              || i == PAGE_DOWN || i == CTL_PAGE_DOWN)
            {
              switch (i)
                {
                case DOWN_ARROW:
                case DOWN_ARROW_2: /* down one line */
                ...
                case UP_ARROW_2:  /* up one line */
                  ...
                  break;
                case LEFT_ARROW:
                case LEFT_ARROW_2:  /* left one column */
                  ...
                  break;
                case RIGHT_ARROW:
                case RIGHT_ARROW_2: /* right one column */
                  ...
                  break;
                case PAGE_DOWN:
                case CTL_PAGE_DOWN: /* down 17 lines */
                  if (in_scrolling_mode && top_line < lines_in_entry - 17)
                    {
                      top_line += 17;
                ...
                case CTL_END:       /* to end of entry */
                  ...
                  break;
                case HOME:
                case CTL_HOME:     /* to beginning of entry */
                  if (in_scrolling_mode)
                    {
